...
wget -c https://gitlab.com/sofija.p2018/kla-ot2/-/raw/main/KLA_modules/wd_grubconfig && chmod +x wd_grubconfig  # When run finds correct grub menu stanza for your system
wget -c https://gitlab.com/sofija.p2018/kla-ot2/-/raw/main/KLA_modules/modify_initrd_gz.sh && chmod +x modify_initrd_gz.sh  # For 'experts' to modify initrd.gz
wget -c https://gitlab.com/sofija.p2018/kla-ot2/-/raw/main/KLA_modules/mount_chroot.sh && chmod +x mount_chroot.sh  # To enter rootfs in a chroot
wget -c https://gitlab.com/sofija.p2018/kla-ot2/-/raw/main/KLA_modules/umount_chroot.sh && chmod +x umount_chroot.sh  # to 'clean up mounts used by above mount_chroot.sh'
wget -c https://gitlab.com/sofija.p2018/kla-ot2/-/raw/main/KLA_modules/mount_chroot_umount.sh && chmod +x mount_chroot_umount.sh  # combined mount and umount chroot...
